...
{{-- Meta Title --}}
@section('title', 'Import technical characteristic - Dashboard')

{{-- Page Title --}}
@section('page-title', 'Technical characteristic')
...
{{-- Content Section --}}
@section('content')
    {!! BootForm::open()->put()->action(route('characteristics.import'))->multipart() !!}
